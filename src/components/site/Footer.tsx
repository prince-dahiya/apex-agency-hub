    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid md:grid-cols-4 gap-10">
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm text-muted-foreground">
          ...
          <li><a href="https://wa.me/918683899730" target="_top" className="hover:text-foreground inline-flex items-center gap-2"><MessageCircle className="h-4 w-4" /> WhatsApp</a></li>
          <li><a href="https://www.instagram.com/northstarr.co.in/" target="_top" className="hover:text-foreground inline-flex items-center gap-2"><Instagram className="h-4 w-4" /> Instagram</a></li>
        </ul>
      </div>
    </div>
